...
function boolSetting(settings: Setting[], key: string): boolean {
...
export async function getOaiFilesDescription(
  ...
  const description: ServiceDescription = [
    ...
    },
    {
      ...
      method: "POST",
      description: "Part of OAI Files. Returns a signed download URL for a file in agent-scoped storage.",
      parameters: {
    ...
    },
    {
      ...
      method: "POST",
      description: "Part of OAI Files. Returns a signed download URL for a file in layer-scoped storage.",
      parameters: {
        path: { type: "string", optional: false, description: "Path to the file." },
      },
    },
    {
      ...
      method: "POST",
      description: "Part of OAI Files. Returns a signed upload URL for uploading a file to agent-scoped storage.",
      parameters: {
    ...
    },
    {
      ...
      method: "POST",
      description: "Part of OAI Files. Returns a signed upload URL for uploading a file to layer-scoped storage.",
      parameters: {
        path: { type: "string", optional: false, description: "Destination path for the file." },
        content_type: { type: "string", optional: false, description: "MIME type of the file." },
      },
    ...
    ...(orchRead ? [
      {
        ...
        parameters: {
          path: { type: "string" as const, optional: true, description: "Directory path to list. Omit for root." },
        },
      },
      {
        ...
        parameters: {
          path: { type: "string" as const, optional: false, description: "Path to the file." },
        },
      },
      {
    ...
    ...(orchWrite ? [
      {
        ...
        method: "POST" as const,
        description: "Part of OAI Files. Returns a signed upload URL for uploading a file to orchestration-scoped storage.",
        parameters: {
      ...
      },
      {
        ...
        parameters: {
          path: { type: "string" as const, optional: false, description: "Path to the file to delete." },
        },
      },
      {
        ...
        parameters: {
          path: { type: "string" as const, optional: false, description: "Directory path to create." },
        },
      },
      {
        ...
        parameters: {
          path: { type: "string" as const, optional: false, description: "Directory path to delete." },
        },
      },
    ] : []),
    ...
    ...(workspaceWrite ? [
      {
        ...
        method: "POST" as const,
        description: "Part of OAI Files. Returns a signed upload URL for uploading a file to workspace-scoped storage.",
        parameters: {
          path: { type: "string" as const, optional: false, description: "Destination path for the file." },
          content_type: { type: "string" as const, optional: false, description: "MIME type of the file." },
        },
...
export const oaiFilesDescription: ServiceDescription = [
  // ── List directory ──────────────────────────────────────────────────────────
  {
    path: "list_files_workspace",
    method: "POST",
    description: "Part of OAI Files. Lists files and subdirectories at the given path in workspace-scoped storage. Omit path to list the root.",
    parameters: {
      path: { type: "string", optional: true, description: "Directory path to list. Omit for root." },
    },
  },
  {
    path: "list_files_orchestration",
    method: "POST",
    description: "Part of OAI Files. Lists files and subdirectories at the given path in orchestration-scoped storage.",
    parameters: {
      path: { type: "string", optional: true, description: "Directory path to list. Omit for root." },
  ...
  // ── Get download URL ────────────────────────────────────────────────────────
  {
    path: "get_download_url_workspace",
    method: "POST",
    description: "Part of OAI Files. Returns a signed download URL for a file in workspace-scoped storage.",
    parameters: {
      path: { type: "string", optional: false, description: "Path to the file." },
  ...
  {
    path: "get_download_url_orchestration",
    method: "POST",
    description: "Part of OAI Files. Returns a signed download URL for a file in orchestration-scoped storage.",
    parameters: {
      path: { type: "string", optional: false, description: "Path to the file." },
  ...
  {
    path: "get_upload_url_orchestration",
    method: "POST",
    description: "Part of OAI Files. Returns a signed upload URL for uploading a file to orchestration-scoped storage.",
    parameters: {
      path: { type: "string", optional: false, description: "Destination path for the file." },
  ...
  {
    path: "delete_file_orchestration",
    method: "POST",
    description: "Part of OAI Files. Permanently deletes a file from orchestration-scoped storage.",
    parameters: {
      path: { type: "string", optional: false, description: "Path to the file to delete." },
  ...
  // ── File metadata ───────────────────────────────────────────────────────────
  {
    path: "get_file_metadata_workspace",
    method: "POST",
    description: "Part of OAI Files. Returns metadata (size, content type, custom metadata, timestamps) for a file in workspace-scoped storage.",
    parameters: {
      path: { type: "string", optional: false, description: "Path to the file." },
    },
  },
  {
    path: "get_file_metadata_orchestration",
    method: "POST",
    description: "Part of OAI Files. Returns metadata for a file in orchestration-scoped storage.",
    parameters: {
      path: { type: "string", optional: false, description: "Path to the file." },
